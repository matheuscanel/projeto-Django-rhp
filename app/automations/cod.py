...
#obter a data e hora atuais
    ...
    conn = sqlite3.connect(r'\Users\60925\Desktop\projeto Django\db.sqlite3')
    ...
    cursor.execute('SELECT cpf, nome, cracha, data_nascimento, sexo, estado_civil, raca, estado_nascimento, cidade_nascimento, cep, grau_de_instrucao FROM "app_medicos"')
    
    dados = cursor.fetchall()
    
    for cpf, nome, cracha, data_nascimento, sexo, estado_civil, raca, estado_nascimento, cidade_nascimento, cep, grau_de_instrucao in dados:  # Desempacotando diretamente as variáveis cpf e nome
